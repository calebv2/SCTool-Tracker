...
class GameOverlay(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.show_simple_kill_notification = lambda victim, weapon=None, event_type='player_destruction': show_simple_kill_notification(self, victim, weapon, event_type)
        self.show_simple_death_notification = lambda attacker, weapon=None, event_type='player_destruction': show_simple_death_notification(self, attacker, weapon, event_type)
